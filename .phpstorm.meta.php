...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Services\MessageBroker' => \App\Services\RabbitMqBroker::class,
    ...
    override(\config(), map([
            ...
            'cache.prefix' => 'string',
            'codeanalyzer.name' => 'string',
            'codeanalyzer.api_uri' => 'string',
            'codeanalyzer.gh_uri' => 'string',
            'codeanalyzer.gh_key' => 'string',
            'codeanalyzer.rabbitmq_host' => 'string',
            'codeanalyzer.rabbitmq_port' => 'string',
            'codeanalyzer.rabbitmq_username' => 'string',
            'codeanalyzer.rabbitmq_password' => 'string',
            'codeanalyzer.rabbitmq_queue' => 'string',
            ...
            'filesystems.links./home/dennis/Projects/codeanalyzer/public/storage' => 'string',
...
'cache.stores.octane.driver','cache.prefix','codeanalyzer.name','codeanalyzer.api_uri','codeanalyzer.gh_uri',
'codeanalyzer.gh_key','codeanalyzer.rabbitmq_host','codeanalyzer.rabbitmq_port','codeanalyzer.rabbitmq_username','codeanalyzer.rabbitmq_password',
'codeanalyzer.rabbitmq_queue','database.default','database.connections.sqlite.driver','database.connections.sqlite.url','database.connections.sqlite.database',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/dennis/Projects/codeanalyzer/public/storage','logging.default','logging.deprecations.channel',
...
'debugbar.queries.explain','dashboard','profile.edit','profile.update',
'profile.destroy','codeanalyzer.createjob','codeanalyzer.createjob.post','job.cancel','codeanalyzer.job',
'codeanalyzer.index','codeanalyzer.createissue','codeanalyzer.storeissue','codeanalyzer.issues','codeanalyzer.showissue',
'codeanalyzer.settings','codeanalyzer.postsettings','ajax.gettree','ajax.getrepositories','ajax.getbranches',
...
'auth.verify-email','components.application-logo','components.auth-session-status','components.button-blue','components.column-table',
'components.danger-button','components.data-table','components.dropdown','components.dropdown-link','components.header-table',
'components.input-error','components.input-label','components.link','components.message','components.modal',
'components.nav-link','components.page-container','components.primary-button','components.rendertree','components.rendertree2',
'components.responsive-nav-link','components.row-table','components.secondary-button','components.text','components.text-input',
'components.text-input-xl','dashboard','inertia.layout','issues.create','issues.index',
'issues.show','jobs.createjob1','jobs.createjob2','jobs.index','jobs.jobdetails',
'layouts.app','layouts.guest','layouts.master','layouts.navigation','mails.joberror',
'profile.edit','profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form','settings.index',
...
'exceptions.auth_failed','exceptions.resource_missing','exceptions.conflict','exceptions.issues_disabled','exceptions.validation',
'exceptions.unknown','issue.create','issue.empty','issue.createsuccess','job.supplygit',
'job.owner','job.repository','job.branch','job.optional','job.next',
'job.none','job.busy','job.ready','job.create','job.createfailed',
'messages.activejob','messages.noapi','messages.cancel','messages.details','messages.sessionmissing',
...
'AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','CODEANALYZER_API_URI',
'GITHUB_API_URI','GITHUB_API_KEY','RABBITMQ_HOST','RABBITMQ_PORT','RABBITMQ_QUEUE',
